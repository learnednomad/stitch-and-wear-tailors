...
// Enums
export const FabricCategorySchema = z.enum(['cotton', 'silk', 'wool', 'linen', 'polyester', 'denim', 'velvet', 'leather', 'synthetic'])
export const FabricWeightSchema = z.enum(['lightweight', 'medium', 'heavyweight'])
export const FabricPatternSchema = z.enum(['solid', 'striped', 'checkered', 'floral', 'geometric', 'abstract', 'paisley'])
export const FabricAvailabilitySchema = z.enum(['in_stock', 'low_stock', 'out_of_stock', 'pre_order'])
