...
export const validateCreateMeasurementInput = (data: unknown) =>
  CreateMeasurementInputSchema.parse(data)
export const validateUpdateMeasurementInput = (data: unknown) =>
  UpdateMeasurementInputSchema.parse(data)
export const validateMeasurementComparison = (data: unknown) =>
  MeasurementComparisonSchema.parse(data)
