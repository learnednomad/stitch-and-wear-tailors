...
export const NotificationTypeSchema = z.enum([
  'order_update', 'appointment_reminder', 'payment_due', 'measurement_required',
  'fitting_scheduled', 'order_completed', 'promotional', 'system_maintenance', 'account_update'
])
...
export const validateCreateNotificationInput = (data: unknown) => CreateNotificationInputSchema.parse(data)
export const validateUpdateNotificationInput = (data: unknown) => UpdateNotificationInputSchema.parse(data)
export const validateNotificationPreferences = (data: unknown) => NotificationPreferencesSchema.parse(data)
