...
export const validateCreateAppointmentInput = (data: unknown) =>
  CreateAppointmentInputSchema.parse(data)
export const validateUpdateAppointmentInput = (data: unknown) =>
  UpdateAppointmentInputSchema.parse(data)
export const validateAppointmentAvailability = (data: unknown) =>
  AppointmentAvailabilitySchema.parse(data)
