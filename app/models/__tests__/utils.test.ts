...
describe('Utility Functions', () => {
  describe('Transformers', () => {
    ...
    it('should safely transform with error handling', () => {
      const invalidTransformer = () => { throw new Error('Transform failed') }
  ...
  describe('Serializers', () => {
    ...
    it('should merge model updates', () => {
      ...
      expect(new Date(merged.updatedAt).getTime()).toBeGreaterThan(new Date(user.updatedAt).getTime())
    })
  })
  ...
  describe('Validators', () => {
    ...
    it('should validate multiple validation results', () => {
      ...
      const invalidResult = { valid: false, errors: [{ field: 'test', message: 'Error', code: 'TEST_ERROR' }] }
