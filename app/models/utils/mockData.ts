...
export const mockData = {
  user: (overrides?: Partial<User>): User => {
    ...
    const firstName = randomElement(['John', 'Jane', 'Michael', 'Sarah', 'David', 'Emily', 'Robert', 'Lisa'])
    const lastName = randomElement(['Smith', 'Johnson', 'Williams', 'Brown', 'Jones', 'Garcia', 'Miller', 'Davis'])
  ...
  order: (overrides?: Partial<Order>): Order => {
    const statuses: OrderStatus[] = ['pending', 'confirmed', 'measuring', 'cutting', 'stitching', 'fitting', 'ready']
  ...
  fabric: (overrides?: Partial<Fabric>): Fabric => {
    ...
    return {
      ...
      colors: {
        ...
        colorName: randomElement(['Navy Blue', 'Jet Black', 'Pure White', 'Charcoal Gray', 'Chocolate Brown']),
      },
      inventory: {
  ...
  style: (overrides?: Partial<Style>): Style => {
    ...
    const styleNames = ['Classic Suit', 'Business Shirt', 'Casual Dress', 'Formal Jacket', 'Custom Blazer']
