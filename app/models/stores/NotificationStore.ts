...
const NotificationModel = types.model("Notification", {
  ...
  // Related data
  relatedEntityType: types.maybeNull(
    types.enumeration("EntityType", ["order", "appointment", "measurement", "user"]),
  ),
 ...
 */
const NotificationsCollectionModel = createCollectionModel(
 ...
 */
const TemplatesCollectionModel = createCollectionModel(
  "TemplatesCollection",
...
export const NotificationStoreModel = types
  .model("NotificationStore", {
    ...
    permissions: types.model("NotificationPermissions", {
      push: types.optional(
        types.enumeration("PermissionStatus", ["granted", "denied", "default"]),
        "default",
      ),
    ...
    deliveryQueue: types.array(
      types.model("QueuedNotification", {
  ...
  .actions((self) => {
    ...
    return {
       ...
       */
      sendOrderUpdateNotification: flow(function* (
        orderId: string,
        userId: string,
        status: string,
      ) {
       ...
       */
      sendAppointmentReminder: flow(function* (
